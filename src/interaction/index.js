...
const NICE_REACTIONS = [
    ...
    "^ nice1",
    "lol :joy-cry:",
    "@anonymous_citizen such good point very waow will u marry me",
    "@anonymous_citizen Responses like this make me frekking love this community. SO. MUCH.",
...
const MEAN_REACTIONS = [
    ...
    `lol just fyi - ur moms not an "anonymous citizen" b/c we had raunchy deep throat penetration last night if you knowk what I mean, ur mom is like ok in bed but not stellar in case you were wondering`,
