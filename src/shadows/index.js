...
const longShadowTexts: Array<string> = [
...
const mediumShadowTexts: Array<string> = [
  ...
  "This is the way to make your mark. To be the one they talk about. The one who was daring and dangerous and didn’t follow the rules. Every time they gather, they will recount the legend of you.",
  "So unfair, the way you were treated that time. You know the time I’m talking about, but we can’t name names. Or can we?",
...
const shortShadowTexts: Array<string> = [
...
export default function getSubliminalStep(): Step {
